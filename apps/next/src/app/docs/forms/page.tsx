...
export default function FormsIndexPage() {
  ...
  return (
    <div className="min-h-dvh">
      ...
      <Button form="formica" type="submit">
        {' '}
        Invia{' '}
      </Button>
            ...
            <PopoverTrigger asChild>
              ...
              >
                {value
                  ...
                  : 'Select framework...'}
                <CarFront className="w-4 h-4 ml-2 opacity-50 shrink-0" />
              </Button>
            </PopoverTrigger>
            <Command>
              <PopoverContent>
                <CommandInput placeholder="Filter fruits" aria-label="Filter fruits" />
                  ...
                  {frameworks.map((fr) => (
                    ...
                    >
                      ...
                      <span className="ml-auto">
                        <CheckboxBase
                          className="w-4 h-4 "
                          checked={value.includes(fr.value)}
                          onCheckedChange={() => {
