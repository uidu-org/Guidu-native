...
export type GuiDatepickerProviderProps = PropsWithChildren<DatepickerContext>

export const GuiDatepickerProvider = ({ children, ...value }: GuiDatepickerProviderProps) => {
