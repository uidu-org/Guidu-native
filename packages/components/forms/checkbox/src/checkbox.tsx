      ...
      <div>
        <div className="flex items-center mb-1">
          <CheckboxPrimitive.Root
            ...
            className={cn(
              'bg-transparent border-2 border-black rounded-md flex items-center justify-center shadow-md focus:border-black focus:shadow-black',
          ...
          {label && (
            <label className={cn('ms-3', labelClassName)} htmlFor={id}>
              {label}
            </label>
          )}
        </div>
